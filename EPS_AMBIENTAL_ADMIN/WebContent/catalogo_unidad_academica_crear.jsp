...
<body>
	...
	<div class="div-formulario">
		...
		<form action="unidad_controlador?command=create" method="post">
		 	<table>
		 		<tr>
 	...
 	<div class="div-return">
		<button class="button button5" onclick="window.location.href='unidad_controlador?command=showAll'">Unidad Académica<i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
		</button>
	</div>
</body>
</html>