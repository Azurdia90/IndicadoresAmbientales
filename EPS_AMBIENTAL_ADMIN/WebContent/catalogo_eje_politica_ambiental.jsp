...
<body>
	...
	<div class = "div-menu-formulario">
		<form action="ejes_politica_ambiental_controlador" method="get">
		 	<label>Catalogo Eje de politica ambiental</label>
			<button class="button button1" style="height: 3vw; width:9vw;" type="submit" name="command" value="create">Crear Eje de politica ambiental</button>
 	...
 	<div class="div-tabla-indicadores">	
		...
		<table border="1" class="tableindicadores">
		    ...
		    <c:forEach items="${ejes_politicas_ambientales}" var="eje_politica_ambiental" >
	            <tbody>
	            	<tr data-variable-id="${eje_politica_ambiental.getId()}">
		                <td><c:out value="${eje_politica_ambiental.getCodigo()}"/></td>
		                <td><c:out value="${eje_politica_ambiental.getNombre()}"/></td>
		                <td align="center">
	    ...
	    document.addEventListener("DOMContentLoaded", function () {
	        ...
	        editbuttons.forEach(function (edit_button) {
	            edit_button.addEventListener("click", function () {
	                ...
	                window.location.href = "ejes_politica_ambiental_controlador?command=edit&id=" + variableId;
	            });
	        });
	        ...
	        deletebuttons.forEach(function (delete_button) {
	            delete_button.addEventListener("click", function () {
	                ...
	                fetch("ejes_politica_ambiental_controlador?command=delete&id=" + variableId, {
	                    method: "DELETE",
	                    headers: {
