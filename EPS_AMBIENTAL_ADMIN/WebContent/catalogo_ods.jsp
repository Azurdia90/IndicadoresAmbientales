...
<body>
	...
	<div class = "div-menu-formulario">
		<form action="ods_controlador" method="get">
		 	<label>Catalogo de ODS</label>
			<button class="button button1" type="submit" name="command" value="create">Crear ODS</button>
 	...
 	<div class="div-tabla-2">	
		...
		<table border="1" class="table2">
		    ...
		    <c:forEach items="${ods}" var="ods_" >
	            <tbody>
	            	<tr data-variable-id="${ods_.getId()}">
		                <td><c:out value="${ods_.getCodigo()}"/></td>
		                <td><c:out value="${ods_.getNombre()}"/></td>
		                <td align="center">
	    ...
	    document.addEventListener("DOMContentLoaded", function () {
	        ...
	        editbuttons.forEach(function (edit_button) {
	            edit_button.addEventListener("click", function () {
	                ...
	                window.location.href = "ods_controlador?command=edit&id=" + variableId;
	            });
	        });
