...
<body>
	...
	<div class = "div-menu-formulario">
		<form action="periodicidad_controlador" method="get">
		 	<label>Catalogo Periodicidad</label>
			<button class="button button1" type="submit" name="command" value="create">Crear Periodicidad</button>
 	...
 	<div class="div-tabla-2">	
		...
		<table border="1" class="table2">
		    ...
		    <c:forEach items="${periodicidades}" var="periodicidad" >
	            <tbody>
	            	<tr data-variable-id="${periodicidad.getId()}">
		                <td><c:out value="${periodicidad.getCodigo()}"/></td>
		                <td><c:out value="${periodicidad.getNombre()}"/></td>
		                <td align="center">
	    ...
	    document.addEventListener("DOMContentLoaded", function () {
	        ...
	        editbuttons.forEach(function (edit_button) {
	            edit_button.addEventListener("click", function () {
	                ...
	                window.location.href = "periodicidad_controlador?command=edit&id=" + variableId;
	            });
	        });
	        ...
	        deletebuttons.forEach(function (delete_button) {
	            delete_button.addEventListener("click", function () {
	                ...
	                fetch("periodicidad_controlador?command=delete&id=" + variableId, {
	                    method: "DELETE",
	                    headers: {
