...
<body>
	...
	<div class = "div-menu-formulario">
		<form action="areas_geograficas_controlador" method="get">
		 	<label>Catalogo de Areas Geograficas</label>
			<button class="button button1" type="submit" name="command" value="create">Crear Area Geografica</button>
 	...
 	<div class="div-tabla-2">	
		...
		<table border="1" class="table2">
		    ...
		    <c:forEach items="${areas_geograficas}" var="area_geografica" >
	            <tbody>
	            	<tr data-variable-id="${area_geografica.getId()}">
		                <td><c:out value="${area_geografica.getCodigo()}"/></td>
		                <td><c:out value="${area_geografica.getNombre()}"/></td>
		                <td align="center">
	    ...
	    document.addEventListener("DOMContentLoaded", function () {
	        ...
	        editbuttons.forEach(function (edit_button) {
	            edit_button.addEventListener("click", function () {
	                ...
	                window.location.href = "areas_geograficas_controlador?command=edit&id=" + variableId;
	            });
	        });
	        ...
	        deletebuttons.forEach(function (delete_button) {
	            delete_button.addEventListener("click", function () {
	                ...
	                fetch("areas_geograficas_controlador?command=delete&id=" + variableId, {
	                    method: "DELETE",
	                    headers: {
