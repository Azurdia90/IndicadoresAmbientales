...
/**
 * Servlet implementation class ap_controller
 */
@WebServlet("/ap_controller")
public class ap_controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ap_controller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Pagina_ambiental contenido = new Pagina_ambiental(7);
		...
		if(contenido.getVisible() == 1)
		{
			...
			{
				System.out.println("Exception ap_controller - doGet:" + e.getMessage());
			}
		}
		else
		{
