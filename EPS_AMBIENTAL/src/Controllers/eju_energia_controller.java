...
/**
 * Servlet implementation class eju_energia_controller
 */
@WebServlet("/eju_energia_controller")
public class eju_energia_controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public eju_energia_controller() {
        super();
