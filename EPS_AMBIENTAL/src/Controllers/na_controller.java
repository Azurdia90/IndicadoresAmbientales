...
/**
 * Servlet implementation class na_controller
 */
@WebServlet("/na_controller")
public class na_controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public na_controller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Pagina_ambiental contenido = new Pagina_ambiental(8);
		...
		{
			System.out.println("Exception na_controller - doGet:" + e.getMessage());
		}
		
		request.getRequestDispatcher("na.jsp").forward(request, response);
