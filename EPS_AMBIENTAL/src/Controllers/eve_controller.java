...
/**
 * Servlet implementation class eve_controller
 */
@WebServlet("/eve_controller")
public class eve_controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public eve_controller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Pagina_ambiental contenido = new Pagina_ambiental(6);
		...
		{
			System.out.println("Exception eve_controller - doGet:" + e.getMessage());
		}
		
		request.getRequestDispatcher("eve.jsp").forward(request, response);
