...
/**
 * Servlet implementation class eju
 */
@WebServlet("/eju_controller")
public class eju_controller extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public eju_controller() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Pagina_ambiental contenido = new Pagina_ambiental(4);
		...
		{
			System.out.println("Exception eju_controller - doGet:" + e.getMessage());
		}
		
		request.getRequestDispatcher("eju.jsp").forward(request, response);
